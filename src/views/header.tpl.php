  ...
  <header>
    ...
    <nav class="navbar navbar-expand-md navbar-light">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
       ...
       <!-- J'aurais bien mis ça pour le href, mais ça explose le header en mode carrés oranges : <?= $viewVars['router']->generate('main-showhome') ?>-->
          </li>
          <li class="nav-item">
    ...
    <section class="text-center">
      <h1>Découvrez l'étendue du monde de Sonic</h1>
      <hr />
      <p>
        Un site qui remplacera bientôt Wikipédia, on commence light mais vous verrez
      </p>
    </section>
  </header>
